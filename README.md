...
Evaluación: 1,2,3
Dominio: Amazon EKS, Amazon ECS, Amazon ECR, Amazon EC2, Amazon VPC, Internet Gateway, NAT Gateway, Security Groups, Elastic Load Balancer (ELB / ALB), AWS IAM, Amazon CloudWatch, AWS CLI, AWS Academy, Amazon S3, GitHub Actions, GitHub Secrets y variables
...
Actividad 3.1: Fundamentos de la orquestación de contenedores
...
Actividad 3.2: Implementación de infraestructura base en AWS
...
Actividad 3.3: Integración teórica de CI/CD
...
Actividad 3.4: Construcción del Pipeline automatizado
...
Actividad 3.5: Ejecución y validación del Pipeline CI/CD
...
Amazon EKS (Elastic Kubernetes Service): El servicio principal utilizado para orquestar y administrar el clúster de Kubernetes en la nube
...
AWS Academy (Vocareum / Learner Lab): La plataforma educativa que provee el entorno de nube y los tokens temporales (AWS_SESSION_TOKEN) para realizar la actividad
